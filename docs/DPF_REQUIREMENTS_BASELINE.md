...
| DPF-PHYS-008 | P0 | Circuit feedback for first-principles mode shall be driven by resolved field power and conservation ledgers, not Lee/RADPF closure factors. | Physics/Engine | partial | test, analysis | `docs/FIRST_PRINCIPLES_FINISH_LINE_PLAN.md`; `dpf first-principles` emits field-coupled engineering evidence, but field-coupling acceptance remains blocked. |
| DPF-PHYS-009 | P0 | First-principles PF-1000/Akel runs shall reject hidden engineering limiters for accepted claims. | Physics/Engine | blocked | test, inspection | Current first-principles candidate reports explicit resistivity/state/field limiters as engineering blockers; no accepted limiter-free scientific run exists. |
...
| DPF-PHYS-014 | P0 | First-principles acceptance shall define dimensionality and any MHD-to-kinetic handoff for the claimed interval and observables. | Physics/Architecture | blocked | analysis, test, review | No accepted dimensionality or handoff packet exists; current candidate is axisymmetric engineering MHD. |
...
| DPF-PHYS-016 | P0 | The active first-principles circuit power port shall pass Poynting or `J.E`, electrode-work, time-centering, sign, and residual tests without clipped back-EMF for acceptance. | Physics/Engine | blocked | test, analysis | Current field-coupled probe still uses engineering power/back-EMF caps and candidate-only diagnostics. |
