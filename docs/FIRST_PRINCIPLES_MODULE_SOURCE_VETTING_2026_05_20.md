...
KnowledgeReference plus explicitly user-verified staged sources only; module source-vetting is non-validating and does not invoke the dpf-validation workflow

## Summary

- Total modules: `293`
- Active first-principles import-closure modules: `57`
- Physics-facing modules: `180`
- Modules with source references: `69`
...
- Module role reviews required: `0`

## Classification Counts

- `active_physics_source_referenced`: `48`
...
- `reduced_or_baseline_only_not_first_principles_authority`: `30`
