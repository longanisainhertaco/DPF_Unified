...
1. **Digitize Akel (2021) Fig. 3 waveform** (4-8 hr, +0.15-0.25): Obtain the actual paper (DOI: 10.1016/j.radphyschem.2021.109638) and digitize the PF-1000 16 kV I(t) waveform from Figure 3. Replace the reconstructed waveform with real data. Re-run blind_predict(). If NRMSE < 0.20 on genuinely independent data, this is the single action most likely to break the 7.0 ceiling. **This is the most important recommendation from Debate #43.**
