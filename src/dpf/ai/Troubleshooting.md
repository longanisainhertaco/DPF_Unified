...
> **Note (2026-04-24)**: `preconditioner.py` was deleted as dead code (135 LOC, never wired into the solver). All findings below referencing `preconditioner.py` (CRIT-1, HIGH-3, HIGH-4) are historical — the file no longer exists in the tree.
