...
# Per-device migrations (D2 Option A, per-device modules under devices/).
# PF1000_DATA is now defined in dpf.validation.devices._pf1000 and re-exported
# here for backward compatibility. Numerical values are unchanged.
from dpf.validation.devices._pf1000 import PF1000_DATA  # noqa: E402,F401
