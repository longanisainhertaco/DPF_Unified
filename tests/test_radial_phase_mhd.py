...
class TestRadialPhaseMHD:
    ...
    def test_radial_collapse_full_evolution(self, radial_phase_setup) -> None:
        ...
        # Components (E_field_0, E_cap_0, E_ind_ext_0, E_res_0) are consumed
        # individually in the circuit-energy conservation block below; the
        # docstring's "E_total_0" sum is computed locally there as needed.
